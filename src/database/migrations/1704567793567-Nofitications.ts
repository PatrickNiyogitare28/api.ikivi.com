...
export class Nofitications1704567793567 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('GROUP_JOIN_REQUEST', 'PERIODIC_CONTRIBUTION', 'LOAN_REQUEST', 'LOAN', 'PERIODIC_EARN', 'CONTRIBUTION_TERM')`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_status_enum" AS ENUM('SEEN', 'NOT_SEEN', 'HIDDEN', 'ARCHIVED', 'DELETED')`);
        ...
        await queryRunner.query(`ALTER TABLE "join-requests" DROP COLUMN "loan_due_date"`);
        ...
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_dfd27c233aa754e652f1b4baa56" FOREIGN KEY ("group") REFERENCES "groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_5fdec6c5f9c7e06de0e30386a82" FOREIGN KEY ("user") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_5fdec6c5f9c7e06de0e30386a82"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_dfd27c233aa754e652f1b4baa56"`);
        ...
        await queryRunner.query(`ALTER TABLE "join-requests" ADD "loan_due_date" TIMESTAMP DEFAULT now()`);
