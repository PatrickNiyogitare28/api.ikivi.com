...
export class EditGroupInfoEntity1697274794866 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "group-info" ADD "available_interest" numeric(10,2) DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "group-info" ADD "current_unpaid_loan" numeric(10,2) DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "group-info" DROP COLUMN "current_unpaid_loan"`);
        await queryRunner.query(`ALTER TABLE "group-info" DROP COLUMN "available_interest"`);
    }
