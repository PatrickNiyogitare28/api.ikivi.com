...
export class JoinRequestEdit1684868053071 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "groups" ALTER COLUMN "created_at" SET DEFAULT '"2023-05-23T18:54:21.866Z"'`);
        await queryRunner.query(`ALTER TABLE "groups" ALTER COLUMN "updated_at" SET DEFAULT '"2023-05-23T18:54:21.866Z"'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "groups" ALTER COLUMN "updated_at" SET DEFAULT '2023-05-23 18:53:59.066'`);
        await queryRunner.query(`ALTER TABLE "groups" ALTER COLUMN "created_at" SET DEFAULT '2023-05-23 18:53:59.066'`);
