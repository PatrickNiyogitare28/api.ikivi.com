...
@ManyToOne(() => ContributionTermEntity, (contributionTerm: ContributionTermEntity) => contributionTerm.contributions)
@Column({nullable: false})
contribution_term: string


@ManyToOne(() => GroupEntity, (group: GroupEntity) => group.contributions)
@Column({ nullable: false})
group: string;

@ManyToOne(() => UserEntity, (user: UserEntity) => user.contributions)
@Column({ nullable: false})
user: string;

@ManyToOne(() => UserEntity, (user: UserEntity) => user.contribution_recorders)
