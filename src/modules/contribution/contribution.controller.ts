...
export class ContributionController {
  ...
  async register(
    ...
    return await this.contributionService.add(
      dto,
      req.user.user_id,
      req.user.role,
    );
  ...
  async listContributions(
    ...
    return await this.contributionService.listTransactions(
      group_id,
      req.user.user_id,
      req.user.role,
    );
  ...
  async getContributionById(
    ...
    return await this.contributionService.getById(
      contribution_id,
      req.user.user_id,
      req.user.role,
    );
  ...
  async editStatus(
    ...
    return await this.contributionService.editStatus(
      contribution_id,
      req.user.user_id,
      req.user.role,
      status,
