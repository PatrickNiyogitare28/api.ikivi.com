...
export class LogsHistoryService {
    ...
    public async getGroupHistory(group_id: string ,user_id: string, role: EUserRole){
        ...
        if(!isGroupMember && role !== EUserRole.SYSTEM_ADMIN) throw new BadRequestException("Access denied")
