...
export class JoinCodesController {
  constructor(private joinCodesService: JoinCodesService) {}
  ...
  @Post('/group/:id')
  @HttpCode(201)
  async create(@Req() req: any, @Param('id') group_id: string) {
  ...
  @Get('/group/:groupId')
  async getActiveCode(@Param('groupId') groupId: string, @Req() req: any) {
