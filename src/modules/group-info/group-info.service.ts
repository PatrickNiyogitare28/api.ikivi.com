...
import { AddOnGroupTotalCapitalDto, GroupOfferedPeriodicContributionDto, InitializeGroupInfoDto, LoanFullyPaidDto, loanOfferedDto } from './dto/group-info.dto';
...
export class GroupInfoService {
    ...
    public  async groupOfferedLoan(dto: loanOfferedDto){
        ...
        const updatedGroupAvailableAmount = groupInfo.available_amount as any - loan_amount;
        ...
        const updatedCurrentUnpaidLoan = groupInfo.current_unpaid_loan + loan_amount;
  ...
  public async groupOfferedPeriodicContribution(dto: GroupOfferedPeriodicContributionDto){
    ...
    const newGroupAvailableAmount =  groupInfo.available_amount.sub(new Decimal(amount));
