...
export class LoanRequestsController {
  constructor(private readonly loanRequestService: LoanRequestsService) {}
  ...
  @ApiParam({ name: 'id', description: 'Loan request id' })
  @Get('/:id')
  async getRequestById(@Param('id') request_id: string, @Req() req: any) {
  ...
  @Get('/group/:group')
  async getRequestByGroup(@Param('group') group_id: string, @Req() req: any) {
  ...
  async getUserLoanRequest(@Param('group') group_id: string, @Req() req: any) {
